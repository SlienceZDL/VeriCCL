...
class TACCLRevScheduler(object):
    ...
    def build_allreduce(self, reduce_coll, send_dict_redscat, send_dict_allgather, ts):
        ...
        return Algorithm.make_implementation(reduce_coll, self.topology, instance, None, steps, cont=True, suffix=f'-gurobisol-{soltype}-{timestamp}')
    
    def build_allreduce_(self, reduce_coll, send_dict_redscat, send_dict_allgather):
        import math
